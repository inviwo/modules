...
struct I1 : public MetaDataType<glm::f64> {
    ...
    std::unique_ptr<MetaDataBase> clone() const override { return std::make_unique<I1>(data_, type_); }
...
struct I2 : MetaDataType<glm::f64> {
    ...
    std::unique_ptr<MetaDataBase> clone() const override { return std::make_unique<I2>(data_, type_); }
...
struct I3 : MetaDataType<glm::f64> {
    ...
    std::unique_ptr<MetaDataBase> clone() const override { return std::make_unique<I3>(data_, type_); }
...
struct J1 : MetaDataType<glm::f64> {
    ...
    std::unique_ptr<MetaDataBase> clone() const override { return std::make_unique<J1>(data_, type_); }
...
struct J2 : MetaDataType<glm::f64> {
    ...
    std::unique_ptr<MetaDataBase> clone() const override { return std::make_unique<J2>(data_, type_); }
...
struct J3 : MetaDataType<glm::f64> {
    ...
    std::unique_ptr<MetaDataBase> clone() const override { return std::make_unique<J3>(data_, type_); }
