#ifndef _IVW_MODULE_TENSORFIELDIO_DEFINE_H_
#define _IVW_MODULE_TENSORFIELDIO_DEFINE_H_
...
#else  // UNIX (GCC)
#define IVW_MODULE_TENSORVISIO_API __attribute__((visibility("default")))
#endif
#else
#ifdef _WIN32
#define IVW_MODULE_TENSORVISIO_API __declspec(dllimport)
#else
