...
template <>
struct TTKTraits<vtkTessellatorFilter> {
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{"Input", "vtkPolyData", -1, R"(This property specifies the input to the Tessellate
filter.)"}};
...
void registervtkTessellatorFilter(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkTessellatorFilter>>();
}
