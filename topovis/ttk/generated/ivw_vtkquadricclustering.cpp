...
template <>
struct TTKTraits<vtkQuadricClustering> {
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{"Input", "vtkPolyData", -1, R"(This property specifies the input to the Quadric
Clustering filter.)"}};
...
void registervtkQuadricClustering(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkQuadricClustering>>();
}
