...
template <>
struct TTKTraits<vtkPCellDataToPointData> {
...
Point Data filter.)"}};
    ...
    static constexpr std::string_view doc = R"(The Cell
...
void registervtkPCellDataToPointData(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkPCellDataToPointData>>();
}
