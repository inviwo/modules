...
template <>
struct TTKTraits<vtkPMaskPoints> {
    ...
    inline static std::array<InputData, 1> inports = {InputData{
        "Input", "vtkDataSet", -1, R"(This property specifies the input to the Mask Points
filter.)"}};
...
void registervtkPMaskPoints(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkPMaskPoints>>();
}
