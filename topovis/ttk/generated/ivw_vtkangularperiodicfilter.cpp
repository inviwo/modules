...
template <>
struct TTKTraits<vtkAngularPeriodicFilter> {
    ...
    inline static std::array<InputData, 1> inports = {InputData{
        "Input", "vtkDataSet", -1, R"(This property specifies the input to the Periodic filter.)"}};
...
void registervtkAngularPeriodicFilter(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkAngularPeriodicFilter>>();
}
