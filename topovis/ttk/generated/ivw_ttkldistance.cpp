...
struct Wrapper0 : FieldSelection {
    ...
    CompositeProperty property{[&]() {
        CompositeProperty tmp{"ScalarField1", "Scalar Field 1",
                              R"(Select the first scalar field to process.)"_help};
...
struct Wrapper1 : FieldSelection {
    ...
    CompositeProperty property{[&]() {
        CompositeProperty tmp{"ScalarField2", "Scalar Field 2",
                              R"(Select the second scalar field to process.)"_help};
        tmp.addProperties(name, fieldAssociation);
        return tmp;
    }()};
...
struct Wrapper2 {
    ...
    StringProperty property{"n", "p parameter",
                            R"(Value of the parameter p for the Lp distance computation (type "inf"
for the L-infinity distance).)"_help,
                            "2"};
};
...
struct Wrapper3 {
    ...
    StringProperty property{"name", "Output name", R"(Name of the output distance field.)"_help,
                            "L2-distance"};
};
...
template <>
struct VTKTraits<ttkLDistance> {
    static constexpr std::string_view uri = "ttk.ttkLDistance";
    static constexpr std::string_view className = "ttkLDistance";
...
void registerttkLDistance(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<ttkLDistance>>();
}
