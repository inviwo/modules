...
struct Wrapper8 {
    ...
    BoolProperty property{"_0scalar", "With field values",
...
struct Wrapper9 {
    ...
    BoolProperty property{"_0vertexId", "With vertex Ids",
...
struct Wrapper10 {
    ...
    BoolProperty property{"_0type", "With sheet type",
...
struct Wrapper11 {
    ...
    BoolProperty property{"_0sheetId", "With sheet Ids",
...
struct Wrapper12 {
    ...
    BoolProperty property{"_1scalar", "With field values",
...
struct Wrapper13 {
    ...
    BoolProperty property{"_1vertexId", "With vertex Ids",
...
struct Wrapper14 {
    ...
    BoolProperty property{"_1edgeId", "With edge Ids",
...
struct Wrapper15 {
    ...
    BoolProperty property{"_1type", "With sheet type",
...
struct Wrapper16 {
    ...
    BoolProperty property{"_1sheetId", "With sheet Ids",
...
struct Wrapper17 {
    ...
    BoolProperty property{"_2sheets", "With 2-sheets",
...
struct Wrapper18 {
    ...
    BoolProperty property{"_2sheetValue", "With field values",
...
struct Wrapper19 {
    ...
    BoolProperty property{"_2sheetParameterization", "With edge length parameterization",
...
struct Wrapper20 {
    ...
    BoolProperty property{"_2sheetId", "With sheet Ids",
...
struct Wrapper21 {
    ...
    BoolProperty property{"_2sheetEdgeId", "With edge Ids",
...
struct Wrapper22 {
    ...
    BoolProperty property{"_2sheetTetId", "With tet Ids",
...
struct Wrapper23 {
    ...
    BoolProperty property{"_2sheetCaseId", "With case Ids",
...
struct Wrapper24 {
    ...
    BoolProperty property{"_2sheetEdgeType", "With edge type",
...
struct Wrapper25 {
    ...
    BoolProperty property{"_3sheetVertexNumber", "3-sheet vertex number",
...
struct Wrapper26 {
    ...
    BoolProperty property{"_3sheetTetNumber", "3-sheet tet number",
...
struct Wrapper27 {
    ...
    BoolProperty property{"_3sheetExpansion", "3-sheet expansion",
...
struct Wrapper28 {
    ...
    BoolProperty property{"_3sheetDomainVolume", "3-sheet domain volume",
...
struct Wrapper29 {
    ...
    BoolProperty property{"_3sheetRangeArea", "3-sheet range area",
...
struct Wrapper30 {
    ...
    BoolProperty property{"_3sheetHyperVolume", "3-sheet hyper volume",
