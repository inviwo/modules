...
template <>
struct TTKTraits<vtkPReflectionFilter> {
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{"Input", "vtkDataSet", -1, R"(This property specifies the input to the Reflect
filter.)"}};
...
void registervtkPReflectionFilter(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkPReflectionFilter>>();
}
