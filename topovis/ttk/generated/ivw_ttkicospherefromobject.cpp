...
struct Wrapper1 {
    ...
    DoubleProperty property{"Scale", "Scale", 1.0, std::pair{0.0, ConstraintBehavior::Ignore},
...
template <>
struct TTKTraits<ttkIcosphereFromObject> {
    ...
    inline static std::array<InputData, 1> inports = {InputData{"Object", "", -1}};
...
void registerttkIcosphereFromObject(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<ttkIcosphereFromObject>>();
}
