...
template <>
struct TTKTraits<vtkResampleToImage> {
...
be probed)"}};
    ...
    static constexpr std::string_view doc =
        R"(Sample attributes using a 3D image as probing mesh.)";
};

void registervtkResampleToImage(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkResampleToImage>>();
}
