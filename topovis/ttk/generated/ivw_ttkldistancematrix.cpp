...
struct Wrapper0 : FieldSelection {
    ...
    CompositeProperty property{[&]() {
        CompositeProperty tmp{"ScalarField", "Scalar Field",
                              R"(Select the scalar field to process. This scalar field should
be available in all blocks of the input vtkMultiBlockDataSet.)"_help};
...
struct VTKTraits<ttkLDistanceMatrix> {
    ...
    static constexpr std::string_view doc =
        R"ivw(This filter computes a matrix of Lp distances between scalar fields.
