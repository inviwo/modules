...
template <>
struct TTKTraits<vtkTextureMapToPlane> {
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{"Input", "vtkDataSet", -1, R"(Set the input to the Texture Map to Plane
filter.)"}};
...
void registervtkTextureMapToPlane(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkTextureMapToPlane>>();
}
