...
template <>
struct TTKTraits<vtkGradientFilter> {
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{"Input", "vtkDataSet", -1, R"(This property specifies the input to the Gradient
(Unstructured) filter.)"}};
...
void registervtkGradientFilter(InviwoModule* module) {
    module->registerProcessor<TTKGenericProcessor<vtkGradientFilter>>();
}
