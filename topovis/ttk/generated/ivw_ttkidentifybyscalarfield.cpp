...
struct Wrapper1 {
    ...
    BoolProperty property{"IncreasingOrder", "Increasing Order",
                          R"(Order for the identification.)"_help, false};
};
...
struct Wrapper2 {
    ...
    BoolProperty property{"StartByOne", "Start By One", R"(Start identication by one.)"_help,
                          false};
};
