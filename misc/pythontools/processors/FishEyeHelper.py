...
# & 'C:\Program Files\ffmpeg\bin\ffmpeg.exe' -framerate 30 -i isabel/fisheye_2K_R_%06d.png \
#  -framerate 30 -i isabel/fisheye_2K_L_%06d.png -c:v libx265 -filter_complex hstack isabel2.mp4
