...
template <>
struct VTKTraits<vtkXMLPartitionedDataSetReader> {
    static constexpr std::string_view uri = "vtk.vtkXMLPartitionedDataSetReader";
    static constexpr std::string_view className = "vtkXMLPartitionedDataSetReader";
...
void registervtkXMLPartitionedDataSetReader(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkXMLPartitionedDataSetReader>>();
}
