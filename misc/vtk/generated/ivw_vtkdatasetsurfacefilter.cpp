...
template <>
struct VTKTraits<vtkDataSetSurfaceFilter> {
    static constexpr std::string_view uri = "vtk.vtkDataSetSurfaceFilter";
...
void registervtkDataSetSurfaceFilter(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkDataSetSurfaceFilter>>();
}
