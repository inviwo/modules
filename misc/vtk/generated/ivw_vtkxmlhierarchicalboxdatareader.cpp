...
template <>
struct VTKTraits<vtkXMLHierarchicalBoxDataReader> {
    static constexpr std::string_view uri = "vtk.vtkXMLHierarchicalBoxDataReader";
...
void registervtkXMLHierarchicalBoxDataReader(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkXMLHierarchicalBoxDataReader>>();
}
