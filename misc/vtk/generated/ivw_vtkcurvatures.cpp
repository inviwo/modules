...
template <>
struct VTKTraits<vtkCurvatures> {
    static constexpr std::string_view uri = "vtk.vtkCurvatures";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  ...
                  .numComp = -1,
                  .doc = R"(This property specifies the input to the Curvature
filter.)"}};
...
void registervtkCurvatures(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkCurvatures>>();
}
