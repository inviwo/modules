...
template <>
struct VTKTraits<vtkTemporalDataSetCache> {
    static constexpr std::string_view uri = "vtk.vtkTemporalDataSetCache";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  ...
                  .numComp = -1,
                  .doc = R"(This property specifies the input of the Temporal Cache
filter.)"}};
...
void registervtkTemporalDataSetCache(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkTemporalDataSetCache>>();
}
