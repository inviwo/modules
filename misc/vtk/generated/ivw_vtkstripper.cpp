...
template <>
struct VTKTraits<vtkStripper> {
    static constexpr std::string_view uri = "vtk.vtkStripper";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  ...
                  .numComp = -1,
                  .doc = R"(This property specifies the input to the Triangle Strips
filter.)"}};
...
void registervtkStripper(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkStripper>>();
}
