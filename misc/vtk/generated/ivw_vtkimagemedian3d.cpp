...
template <>
struct VTKTraits<vtkImageMedian3D> {
    static constexpr std::string_view uri = "vtk.vtkImageMedian3D";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  ...
                  .numComp = 1,
                  .doc = R"(This property specifies the input to the Median
filter.)"}};
...
void registervtkImageMedian3D(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkImageMedian3D>>();
}
