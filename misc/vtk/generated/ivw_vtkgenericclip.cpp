...
template <>
struct VTKTraits<vtkGenericClip> {
    static constexpr std::string_view uri = "vtk.vtkGenericClip";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  ...
                  .numComp = -1,
                  .doc = R"(Set the input to the Generic Clip
filter.)"}};
...
void registervtkGenericClip(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkGenericClip>>();
}
