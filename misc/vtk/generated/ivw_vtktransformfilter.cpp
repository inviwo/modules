...
template <>
struct VTKTraits<vtkTransformFilter> {
    static constexpr std::string_view uri = "vtk.vtkTransformFilter";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  ...
                  .numComp = -1,
                  .doc = R"(This property specifies the input to the Transform
filter.)"}};
    inline static std::array<OutputData, 0> outports = {};
    inline static std::array<Group, 0> groups = {};
    std::tuple<Wrapper0> properties;

    static constexpr std::string_view doc = R"ivw(The Transform
filter allows you to specify the position, size, and
orientation of polygonal, unstructured grid, and
curvilinear data sets.)ivw";
};

void registervtkTransformFilter(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkTransformFilter>>();
}
