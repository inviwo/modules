...
template <>
struct VTKTraits<vtkForceTime> {
    static constexpr std::string_view uri = "vtk.vtkForceTime";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  .dataType = "vtkDataSet",
                  .numComp = -1,
                  .doc = R"(This property specifies the input to the ForceTime filter.)"}};
...
void registervtkForceTime(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkForceTime>>();
}
