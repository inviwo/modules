...
template <>
struct VTKTraits<vtkCellCenters> {
    static constexpr std::string_view uri = "vtk.vtkCellCenters";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  .dataType = "vtkDataSet",
                  .numComp = -1,
                  .doc = R"(This property specifies the input to the Cell Centers
filter.)"}};
...
void registervtkCellCenters(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkCellCenters>>();
}
