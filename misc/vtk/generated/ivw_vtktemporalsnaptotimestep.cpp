...
template <>
struct VTKTraits<vtkTemporalSnapToTimeStep> {
    static constexpr std::string_view uri = "vtk.vtkTemporalSnapToTimeStep";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  ...
                  .numComp = -1,
                  .doc = R"(This property specifies the input of the
filter.)"}};
...
void registervtkTemporalSnapToTimeStep(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkTemporalSnapToTimeStep>>();
}
