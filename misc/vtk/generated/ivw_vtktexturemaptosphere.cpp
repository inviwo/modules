...
template <>
struct VTKTraits<vtkTextureMapToSphere> {
    static constexpr std::string_view uri = "vtk.vtkTextureMapToSphere";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  .dataType = "vtkDataSet",
                  .numComp = -1,
                  .doc = R"(Set the input to the Texture Map to Sphere
filter.)"}};
...
void registervtkTextureMapToSphere(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkTextureMapToSphere>>();
}
