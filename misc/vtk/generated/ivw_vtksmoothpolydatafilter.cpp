...
template <>
struct VTKTraits<vtkSmoothPolyDataFilter> {
    static constexpr std::string_view uri = "vtk.vtkSmoothPolyDataFilter";
...
void registervtkSmoothPolyDataFilter(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkSmoothPolyDataFilter>>();
}
