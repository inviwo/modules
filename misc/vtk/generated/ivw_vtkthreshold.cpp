...
template <>
struct VTKTraits<vtkThreshold> {
    static constexpr std::string_view uri = "vtk.vtkThreshold";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  .dataType = "vtkDataSet",
                  .numComp = 1,
                  .doc = R"(This property specifies the input to the Threshold
filter.)"}};
...
void registervtkThreshold(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkThreshold>>();
}
