...
template <>
struct VTKTraits<vtkXMLMultiBlockDataReader> {
    static constexpr std::string_view uri = "vtk.vtkXMLMultiBlockDataReader";
...
void registervtkXMLMultiBlockDataReader(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkXMLMultiBlockDataReader>>();
}
