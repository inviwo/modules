...
template <>
struct VTKTraits<vtkDataSetRegionSurfaceFilter> {
    static constexpr std::string_view uri = "vtk.vtkDataSetRegionSurfaceFilter";
    ...
    inline static std::array<InputData, 1> inports = {
        InputData{.identifier = "Input",
                  .dataType = "vtkDataSet",
                  .numComp = -1,
                  .doc = R"(This property specifies the input to the Extract Surface
filter.)"}};
...
void registervtkDataSetRegionSurfaceFilter(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkDataSetRegionSurfaceFilter>>();
}
