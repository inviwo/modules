...
struct Wrapper0 {
    bool set(vtkXMLPStructuredGridReader& filter) {
...
partitioned VTK XML structured grid reader.)"_help,
                          std::filesystem::path{""}};
};
...
template <>
struct VTKTraits<vtkXMLPStructuredGridReader> {
    static constexpr std::string_view uri = "vtk.vtkXMLPStructuredGridReader";
    static constexpr std::string_view className = "vtkXMLPStructuredGridReader";
    static constexpr std::string_view identifier = "XMLPStructuredGridReaderCore";
    static constexpr std::string_view displayName = "XML Partitioned Structured Grid Reader";
...
void registervtkXMLPStructuredGridReader(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkXMLPStructuredGridReader>>();
}
