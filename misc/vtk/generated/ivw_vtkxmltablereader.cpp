...
template <>
struct VTKTraits<vtkXMLTableReader> {
    static constexpr std::string_view uri = "vtk.vtkXMLTableReader";
    static constexpr std::string_view className = "vtkXMLTableReader";
    ...
    static constexpr std::string_view doc = R"ivw(The XML table
reader reads the VTK XML table file format. The
standard extension is .vtt.)ivw";
};

void registervtkXMLTableReader(InviwoModule* module) {
    module->registerProcessor<VTKGenericProcessor<vtkXMLTableReader>>();
}
