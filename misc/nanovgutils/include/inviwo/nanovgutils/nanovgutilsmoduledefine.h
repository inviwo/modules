...
#ifdef IVW_MODULE_NANOVGUTILS_EXPORTS
#ifdef _WIN32
#define IVW_MODULE_NANOVGUTILS_API __declspec(dllexport)
#else  // UNIX (GCC)
#define IVW_MODULE_NANOVGUTILS_API __attribute__((visibility("default")))
#endif
#else
#ifdef _WIN32
#define IVW_MODULE_NANOVGUTILS_API __declspec(dllimport)
#else
